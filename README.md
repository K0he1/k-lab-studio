...
毎月のiDeCo掛金、積立時の所得控除、想定利回りによる運用益、一時金受取時の税額をまとめて概算するWebアプリです。課税口座で同額を積み立てた場合との比較も行います。

- **公開サイト:** 準備中
- **技術:** Next.js / TypeScript / Azure Functions / Terraform / Azure Static Web Apps
- **主な機能:** 拠出上限の判定、所得控除の概算、複利運用の試算、受取時課税と課税口座の比較
